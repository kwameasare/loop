...
describe("ReplayPage", () => {
  ...
  it("renders degraded replay evidence instead of a false empty state when cp-api is unavailable", async () => {
    ...
    await waitFor(() => {
      expect(view.container).toHaveTextContent("Replay evidence is unavailable");
