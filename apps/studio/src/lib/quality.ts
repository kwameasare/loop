...
export const QUALITY_CHECKLIST: readonly QualityChecklistItem[] = [
  // Clarity
  {
    id: "cl-job",
    category: "clarity",
    prompt: "One primary job is named and obvious.",
  },
  {
    id: "cl-object",
    category: "clarity",
    prompt: "Object or workflow has a clear name.",
  },
  {
    id: "cl-action",
    category: "clarity",
    prompt: "Primary action is unmistakable.",
  },
  {
    id: "cl-env",
    category: "clarity",
    prompt: "Environment/version visible when relevant.",
  },
  {
    id: "cl-states",
    category: "clarity",
    prompt: "Empty, loading, error, and degraded states are designed.",
  },
  // Control
  {
    id: "co-preview",
    category: "control",
    prompt: "High-impact changes have preview.",
  },
  {
    id: "co-diff",
    category: "control",
    prompt: "Diff from production is visible.",
  },
  {
    id: "co-undo",
    category: "control",
    prompt: "Non-production edits offer undo/recovery.",
  },
  {
    id: "co-rollback",
    category: "control",
    prompt: "Production has a rollback path.",
  },
  {
    id: "co-disabled",
    category: "control",
    prompt: "Disabled actions explain why.",
  },
  // Precision
  { id: "pr-units", category: "precision", prompt: "Numbers include units." },
  {
    id: "pr-status",
    category: "precision",
    prompt: "Status labels are specific, not vague.",
  },
  {
    id: "pr-evidence",
    category: "precision",
    prompt: "Health scores drill down to evidence.",
  },
  {
    id: "pr-cite",
    category: "precision",
    prompt: "AI summaries cite sources.",
  },
  {
    id: "pr-ops",
    category: "precision",
    prompt: "Operational tables sort/filter/export.",
  },
  // Friendliness
  {
    id: "fr-next",
    category: "friendliness",
    prompt: "Next useful action is present.",
  },
  {
    id: "fr-examples",
    category: "friendliness",
    prompt: "Examples are available.",
  },
  {
    id: "fr-errors",
    category: "friendliness",
    prompt: "Errors say what failed and what to do.",
  },
  {
    id: "fr-defaults",
    category: "friendliness",
    prompt: "Forms have tested defaults.",
  },
  {
    id: "fr-stages",
    category: "friendliness",
    prompt: "Long workflows show named stages.",
  },
  // Enterprise readiness
  {
    id: "er-audit",
    category: "enterprise-readiness",
    prompt: "Audit-relevant actions are recorded.",
  },
  {
    id: "er-secrets",
    category: "enterprise-readiness",
    prompt: "Secret boundaries are visible.",
  },
  {
    id: "er-approvals",
    category: "enterprise-readiness",
    prompt: "Approvals visible before block.",
  },
  {
    id: "er-policy",
    category: "enterprise-readiness",
    prompt: "Policy violations name policy and owner.",
  },
  {
    id: "er-export",
    category: "enterprise-readiness",
    prompt: "Evidence is exportable.",
  },
  // Craft
  {
    id: "cr-stable",
    category: "craft",
    prompt: "Layout stable under long values.",
  },
  {
    id: "cr-truncate",
    category: "craft",
    prompt: "No critical truncation without access.",
  },
  {
    id: "cr-keyboard",
    category: "craft",
    prompt: "Keyboard reachable end-to-end.",
  },
  {
    id: "cr-density",
    category: "craft",
    prompt: "Density controls available for tables.",
  },
  {
    id: "cr-emphasis",
    category: "craft",
    prompt: "Visual emphasis maps to risk.",
  },
  // Delight
  {
    id: "de-responsive",
    category: "delight",
    prompt: "At least one pleasant responsiveness moment.",
  },
  {
    id: "de-progress",
    category: "delight",
    prompt: "Progress visible for operations over 1s.",
  },
  {
    id: "de-success",
    category: "delight",
    prompt: "Success satisfying but not noisy.",
  },
  {
    id: "de-motion",
    category: "delight",
    prompt: "Motion clarifies cause/effect.",
  },
  {
    id: "de-reduced",
    category: "delight",
    prompt: "Reduced-motion path equally understandable.",
  },
];
...
export interface QualityReportClientOptions extends UxWireupClientOptions {
  ...
  return {
    ...
    results: report.results.map((r) => {
      ...
      return {
        ...r,
        passed: wasPassed
          ? r.passed.filter((x) => x !== itemId)
          : [...r.passed, itemId],
        failed: wasPassed
          ? [...r.failed, itemId]
          : r.failed.filter((x) => x !== itemId),
      };
    }),
  };
}

export async function fetchQualityReports(
  workspaceId: string,
  opts: QualityReportClientOptions = {},
): Promise<ScreenQualityReport[]> {
  const body = await cpJson<{ items: ScreenQualityReport[] }>(
    `/workspaces/${encodeURIComponent(workspaceId)}/quality/reports`,
    {
      ...opts,
      allowFallback: opts.allowFixture === true,
      fallback: { items: [...SAMPLE_QUALITY_REPORTS] },
    },
  );
  return body.items;
}
...
export async function saveQualityReport(
  ...
  return cpJson<ScreenQualityReport>(
    `/workspaces/${encodeURIComponent(workspaceId)}/quality/reports`,
    {
      ...opts,
      method: "POST",
...
/** Sample reports — explicit component-test/demo data only. Routes fetch cp-api reports. */
export const SAMPLE_QUALITY_REPORTS: readonly ScreenQualityReport[] = [
  {
    ...
    results: QUALITY_CATEGORIES.map((cat) => ({
      category: cat,
      passed: QUALITY_CHECKLIST.filter((i) => i.category === cat).map(
        (i) => i.id,
      ),
      failed: [],
      evidence: QUALITY_CATEGORY_ANCHORS[cat],
  ...
  },
  {
    ...
    results: [
      ...
      },
      {
        ...
        failed: ["pr-cite"],
        evidence:
          "§37.3 — AI summary on Trace cites span ID but not source policy snapshot.",
      },
      {
        category: "friendliness",
        passed: [
  ...
  },
  {
    ...
    results: [
      {
        ...
        evidence:
          "§37.1 — primary job ambiguous between import and parity audit; degraded state missing.",
      },
      {
        category: "control",
      ...
      },
      {
        ...
        failed: ["fr-errors"],
        evidence:
          "§37.4 — error copy on parity drop says 'unknown error', no remediation.",
      },
      {
        category: "enterprise-readiness",
    ...
    notes:
      "Below north-star threshold (§37.7): four categories failing. Triage required.",
  },
];
