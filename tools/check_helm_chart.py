...
REQUIRED_VALUE_PATHS: tuple[tuple[str, ...], ...] = (
    ...
    ("gateway", "pdb", "enabled"),
    ("kbEngine", "enabled"),
    ("kbEngine", "image", "repository"),
    ("kbEngine", "image", "tag"),
    ("kbEngine", "replicaCount"),
    ("kbEngine", "service", "port"),
    ("kbEngine", "resources"),
    ("kbEngine", "autoscaling", "enabled"),
    ("kbEngine", "autoscaling", "minReplicas"),
    ("kbEngine", "autoscaling", "maxReplicas"),
    ("kbEngine", "autoscaling", "targetCPUUtilizationPercentage"),
    ("kbEngine", "pdb", "enabled"),
    ("toolHost", "enabled"),
