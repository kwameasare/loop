"""Hermetic tests for the workspace-service factory in :mod:`_app_state`."""

from __future__ import annotations

import pytest
from loop_control_plane._app_state import _default_workspace_service
...
def test_factory_returns_in_memory_when_postgres_disabled(
    ...
    svc = _default_workspace_service()
...
def test_factory_returns_postgres_when_both_env_vars_set(
    ...
    svc = _default_workspace_service()
    assert isinstance(svc, PostgresWorkspaceService)
