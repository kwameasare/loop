...
- `eu-cost` can map to Hetzner Cloud servers running Kubernetes,
  managed Postgres, MinIO for S3-compatible object storage, and Vault
  Transit KMS via `infra/terraform/envs/prod-hetzner-eu-central` (S775).
